...
def generate_launch_description():
  ...
  # Optional: arise_slam_mid360 (commented out if not available)
  ...
  start_mtare_planner = IncludeLaunchDescription(
    PythonLaunchDescriptionSource(
      [get_package_share_directory('mtare_planner'), '/explore_world.launch.py']),
    launch_arguments={
      'scenario': mtare_planner_config,
    }.items()
  )

  # Optional hardware drivers (commented out if not available)
  # start_mid360 = IncludeLaunchDescription(
  #   PythonLaunchDescriptionSource(
  #     [get_package_share_directory('livox_ros_driver2'), '/launch_ROS2/msg_MID360_launch.py']),
  # )
  #
  # start_theta = IncludeLaunchDescription(
  #   FrontendLaunchDescriptionSource(os.path.join(
  #     get_package_share_directory('receive_theta'), 'launch', 'receive_theta.launch')
  #   )
  # )
  #
  # start_diablo_ctrl = Node(
  #   package='diablo_ctrl',
  ...
  ld.add_action(start_mtare_planner)
  # ld.add_action(start_theta)
  # ld.add_action(start_mid360)
  # ld.add_action(start_diablo_ctrl)
